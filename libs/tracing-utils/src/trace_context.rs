...
impl TraceContext {
    ...
    ///
    /// `root_marker` 例如 `"neon=root=pageserver-walreceiver"` /
    /// `"neon=root=safekeeper-recovery"`。
...
pub const NEON_ROOT_PAGESERVER_WALRECEIVER: &str = "neon=root=pageserver-walreceiver";
pub const NEON_ROOT_SAFEKEEPER_RECOVERY: &str = "neon=root=safekeeper-recovery";
pub const NEON_ROOT_WALPROPOSER: &str = "neon=root=walproposer";

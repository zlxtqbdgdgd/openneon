...
typedef struct walproposer_api
{
	 ...
	 * `PgBackendStatus.trace_context` (feat-033/#3 follow-up: openneon#58).
	 * Until that field lands on this branch, the impl self-generates a random
	 * root and emits `tracestate=neon=walproposer` to mark this segment as the
	 * trace origin (W3C TraceState §3.3 single-token form, design#54 ADR).
	 * Simulation/mock impls typically just return 0.
	 *

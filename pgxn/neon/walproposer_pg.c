 ...
 *   `neon=root=walproposer` 标记, 让下游 (SK / pageserver) 知道这一链路根来自
 *   compute walproposer 自己。
 *
 * 当 feat-033/#3 merge 进 main 后, 应该把这里改成:
									...
									size_t *tracestate_len_out)
{
	...
	int			n;
	const char *root_marker = "neon=root=walproposer";
	size_t		marker_len;
